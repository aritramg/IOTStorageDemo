...
namespace StorageAccount.Repository
{
    ...
    {
        static string connectionString="DefaultEndpointsProtocol=https;AccountName=teststoragearitram;AccountKey=CX4lN0u/c/2WLRO6CFblR61NZNN+FxsVfxIFBY0GfJQCj6NzzlEq+8f0Uk4Ss/WpG/aV8CSiKxYm+AStsyIQag==;EndpointSuffix=core.windows.net";
        ...
        public static async Task<BlobProperties> DownloadBlob(string blobName,string file)
        {
            try
            {
                string path=@"C:\Code\Demo\IOTStorageDemo\Downloads\"+file;
                BlobContainerClient container=new BlobContainerClient(connectionString,blobName);
