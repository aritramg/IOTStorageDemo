...
namespace StorageAccount.Repository
{
    ...
    {
        public static string connectionString="DefaultEndpointsProtocol=https;AccountName=satestaritram;AccountKey=+dOlfkW0kNV0fSacQ/om42oOdz9XRQBkS8OCQtcyntLEgmtTWQYwlWoccCjbOCkduOmz1wDZZbZm+AStJHPYJA==;EndpointSuffix=core.windows.net";
